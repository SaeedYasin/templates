...
export default [
  {
    ...
    output: {
      sourcemap: false, // Chrome Extension gives error for map file
      format: "iife",
      name: "options",
      file: "extension/build/options.js",
    },
    plugins: [
      svelte({
        compilerOptions: {
  ...
  },
  {
    ...
    plugins: [
      ...
      // Watch the `extension` directory and refresh the
      // browser on changes when not in production
      //!production && livereload("extension"), // livereload in content.js causes an error
